...
class NameResolverTest extends TestCase
{
    ...
    /**
     * @covers \PhpParser\V4\NodeVisitor\NameResolver
     */
...
EOC;
        ...
        $parser        = new \PhpParser\V4\Parser\Php7(new \PhpParser\V4\Lexer\Emulative);
        $prettyPrinter = new \PhpParser\V4\PrettyPrinter\Standard;
        $traverser     = new \PhpParser\V4\NodeTraverser;
...
EOC;
    ...
    public function testError(Node $stmt, $errorMsg) {
        $this->expectException(\PhpParser\V4\Error::class);
